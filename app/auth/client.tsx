  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        ...
        description: "Start managing leads and growing revenue.",
        button: signUpPending ? "Signing up..." : "Sign Up",
        helper: "Welcome to LeadFlow. Please enter your details below.",
      };
    }
    ...
    return {
      ...
      description: "Your CRM dashboard awaits.",
      button: signInPending ? "Signing in..." : "Sign In",
      helper: "Welcome to LeadFlow. Please enter your details below.",
    };
  }, [mode, signInPending, signUpPending]);
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Supercharge Your Sales with one workspace for your team.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Intuitive dashboard and guided workflows built to help you close deals faster.
              </p>
            </div>
        ...
        <div className="flex min-h-[720px] items-center justify-center p-4 sm:p-8 lg:p-10">
          <Card id={content.id} className="w-full max-w-md border-secondary/70 shadow-xl">
            <CardHeader className="space-y-4">
              ...
              <div>
                <span className="block text-xs text-muted-foreground pt-2">{content.helper}</span>
              </div>
            </CardHeader>
                ...
                <form className="space-y-4" action={signUpAction}>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input id="signup-first-name" name="firstName" placeholder="Meghna" required />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="signup-last-name">Last name</Label>
                      <Input id="signup-last-name" name="lastName" placeholder="Rajawat" required />
                    </div>
                  </div>
